...
RUN ./gradlew build -PMYSQL_DB_URL="jdbc:mysql://udjp3wqtceerrwhm:OVB9sFZYAvRwbTMZGKhg@bffx9lbwiuxvictcanvn-mysql.services.clever-cloud.com:3306/bffx9lbwiuxvictcanvn"
